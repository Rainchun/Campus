           ...
           <div class="main-wrap" style="width: 950px">
            ...
            <div class=" tab-switch personal-wrap-show" style="margin-top: 30px">
                ...
                <div class="control-group clearfix">
                  ...
                  <?php if($userInfos["gender"] == 0): ?><span>男</span>
                ...
                <div class="control-group clearfix">
                  ...
                  <div class="controls">
                    ...
                    <?php echo ($userInfos["birthday"]); ?>
                    <i class="date-icons"></i>
                    </span>
                    <i class="date-line">－星座：</i><?php echo ($userInfos["constellation"]); ?>
                  </div>
                  <div id="" class="error-place">
                    <i class="tips"></i><span><a target="_blank" ><img src="/Campus/Public/UCenter/img/smrz01.png" style="margin-bottom: -4px;margin-right: 10px;"/>警惕钓鱼网站，慎重约伴出行</a></span>
                  </div>
                </div>
                ...
                <div class="control-group clearfix priority-low">
                  ...
                  <div style="float:left;">
                    <a href="<?php echo U('edit_info');?>"  class="ms-stand-btn1" >修改</a>
