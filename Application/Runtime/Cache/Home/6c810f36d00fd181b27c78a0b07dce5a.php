...
<div class="header" id="ban">
	...
	<div class="container">
		<div class="col-md-9 technology-left" style="margin-bottom: 30px;">
			...
			<h2 class="w3" style="font-family: miaomi"><?php echo ($redmodeltype["rname"]); ?></h2>
	...
	<div class="box">
		<div class="demo">
			<div class="key">	
			<a href="javascript:;" class="rollIn" >发布推荐</a>
			</div>
		</div>
		
		<div id="dialogBg"></div>
		
		<?php if($_SESSION['telephone']== null): ?><div id="dialog" class="animated" style="height: 220px;">
			<div class="dialogTop">
			    <a href="#" style="font-size: 20px; margin-right: 180px;">登录</a>
				<a href="javascript:;" class="claseDialogBtn">关闭</a>
			</div>
			<form action="<?php echo U('Home/Recommend/dologin');?>" method="post" id="editForm" enctype="multipart/form-data">
				<ul class="editInfos">
	...
	<?php else: ?>
		<div id="dialog" class="animated">
			...
			<div class="dialogTop">
			    <a href="#" style="font-size: 20px; margin-right: 40px;">发布你的推荐</a>
				<a href="javascript:;" class="claseDialogBtn">关闭</a>
			</div>
			<form action="<?php echo U('Recommend/doTuijian');?>" method="post" id="editForm" enctype="multipart/form-data">
				<ul class="editInfos">
					<li><input type="text" name="name" value="" class="ipt" style="width: 200px;" placeholder="推荐标题" required  /></li>
					<li><input type="text" name="place" value="" class="ipt" style="width: 200px;" placeholder="所在地" required  /></li>
					<li><select name="rtype_rid" class="ipt"  style="width: 200px;" >
                    ...
                    <li><input type="text" name="cause" value="" class="ipt" style="width: 200px;" placeholder="简介" required  /></li>
                    <li style="margin-left: 47px" class="file">        
                    <input type="file" name="pic" class="ipt" style="width: 200px;" title="主题图片"  /></li>
			...
			<div class="blog-grids1">
             <?php if(is_array($redmodel)): $i = 0; $__LIST__ = $redmodel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-6 blog-grid" style="margin-bottom: 50px;">
					<div class="blog-grid-left1">
						<a href="<?php echo U('Recommend/content',array('id'=>$vo['id']));?>"><img src="/Campus/Public/Home/uploads/recmdphoto/<?php echo ($vo["pic"]); ?>" alt=" " class="img-responsive" style="width: 375px; height: 236px"></a>
						<input type="hidden" value="<?php echo ($vo["id"]); ?>">
					</div> 
					<div class="blog-grid-right1" >
						<a href="<?php echo U('Recommend/content',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a>
						<div class="boxed_mini_details clearfix">
			                         ...
			                         <span class="area first">
			                           ...
			                           <i class="fa fa-plane icon1"></i><?php echo ($vo["praise"]); ?>
			                         </span>			      
                                    </div>
					</div>
					<div class="clearfix"> </div>
					...
					<h4 style="font-family: miaomi">最新推荐</h4>
                     <?php if(is_array($fresh)): $i = 0; $__LIST__ = $fresh;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="blog-grids">
							<div class="blog-grid-left">
								<a href="<?php echo U('Recommend/content',array('id'=>$vo['id']));?>"><img src="/Campus/Public/Home/uploads/recmdphoto/<?php echo ($vo["pic"]); ?>" class="img-responsive" alt=""></a>
							</div>
							<div class="blog-grid-right">
