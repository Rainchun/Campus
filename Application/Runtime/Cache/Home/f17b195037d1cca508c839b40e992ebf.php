          ...
          <div style="margin-left: 200px;">
            ...
            <div class="server-wrapper" style="margin-top: 90px;">
              <div class="server-tab" style="margin-top: 26px;">
                ...
                <div style="width: 950px;padding:10px;display: inline-block; margin-top: 60px;background-color: #fff;float: left;border-bottom: 1px #ccc solid;padding-bottom: 20px;">
                  <span style="text-align: left;line-height: 20px;"><h4><strong>主题推荐</strong></h4></span>
                </div>
                <div style="width: 950px;padding:10px;display: inline-block; margin-top:0px;background-color: #fff;float: left;margin-bottom: 100px">
                  <div style="padding:10px ;text-align: center;float: left;margin-left: 20px;">
                    
                    
                    
                    <?php if(is_array($redmodel)): $i = 0; $__LIST__ = $redmodel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="float: left;margin-left: 30px;">
                      <img src="/Campus/Public/Home/uploads/recmdphoto/<?php echo ($vo["pic"]); ?>" style="height: 125px;width: 180px" />
                      <p style="width: 180px;"><a href="<?php echo U('Recommend/content',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a></p>
                      <span style="display: block;float: left;margin-left: 10px;color: #f78642;font-size: 16px;"><a href="<?php echo U('User/delcol',array('id'=>$vo['cid']));?>" style="color:#f78642 ">删除</a></span>
                       
                       <dl style="    float: left; margin-top: 30px; margin-left: -50px;">浏览量：<?php echo ($vo["hits"]); ?></dl>
                       <dl style="float: right;margin-top: 30px;">赞：<?php echo ($vo["praise"]); ?></dl>
