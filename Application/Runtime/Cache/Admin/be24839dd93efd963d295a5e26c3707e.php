    ...
    <section id="content_wrapper">
      ...
      <section id="content" class="table-layout animated fadeIn">
        ...
        <aside class="tray tray-left tray270" data-tray-height="match">
          ...
          <a href="<?php echo U('user_recmd');?>" class="btn btn-danger light btn-block fw600">返回</a>

          

          <!-- Message Menu -->
          <div class="list-group list-group-links mt20">
           <div class="list-group-header">各推荐类型总数</div>
               <!-- Labels Menu -->
          <div class="list-group list-group-links" style="background: #FFF">
            
            <a href="#" class="list-group-item">
              浏览量
              <span class="badge badge-info"><?php echo ($recmd["hits"]); ?></span>
            </a>
            <a href="#" class="list-group-item">
              收藏量
              <span class="badge badge-success"><?php echo ($recmd["praise"]); ?></span>
            </a>
           <!--  <a href="#" class="list-group-item">
              购物
              <span class="badge badge-primary"><?php echo ($rtype3); ?></span>
            </a>
            <a href="#" class="list-group-item">
              游园观光
              <span class="badge badge-system"><?php echo ($rtype4); ?></span>
            </a>
            <a href="#" class="list-group-item">
              娱乐休闲
              <span class="badge badge-success"><?php echo ($rtype5); ?></span>
            </a>
            <a href="#" class="list-group-item">
              沙滩海岛
              <span class="badge badge-info"><?php echo ($rtype6); ?></span>
            </a> -->
          </div>
          ...
          <div class="panel">
                  ...
                  <div class="row">
                    <div class="hidden-xs hidden-sm col-md-3">
                      <div class="btn-group">
                        ...
                        <?php if($recmd["ischeck"] == '0'): ?><a href="<?php echo U('recmd_check',array('id'=>$recmd['id']));?>"><button type="button" class="btn btn-default light" title="通过审核">
                          <i class="fa fa-check" ></i>
                        </button>
                        <?php else: ?>
                        <a href="<?php echo U('cal_recmd_check',array('id'=>$recmd['id']));?>"><button type="button" class="btn btn-default light" title="审核不通过">
                          <i class="fa fa-ban" ></i>
                        </button><?php endif; ?>
                        <!-- <a href="<?php echo U('recmd_check',array('id'=>$recmd['id']));?>"><button type="button" class="btn btn-default light" title="通过审核">
                          <i class="fa fa-check" ></i>
                        </button>fa-ban -->
            ...
            <div class="message-view">
              ...
              <div class="message-meta">
                ...
                <h3 class="subject"><?php echo ($recmd["name"]); ?></h3>
              ...
              <div class="message-header">
                <img src="/Campus/Public/Home/userphoto/<?php echo ($recmd["upic"]); ?>" class="img-responsive mw40 pull-left mr20">
                ...
                <h4 class="mt15 mb5">From:<?php echo ($recmd["uname"]); ?></h4>
                <small class="text-muted clearfix">From:<?php echo ($recmd["email"]); ?></small>
              </div>
              ...
              <div class="message-body">
                <p><strong>所在地：<?php echo ($recmd["place"]); ?></strong></p>
                <p><?php echo ($recmd["cause"]); ?></p>
