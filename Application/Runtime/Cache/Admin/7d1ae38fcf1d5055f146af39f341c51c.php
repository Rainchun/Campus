        ...
        <div class="topbar-left">
          <ol class="breadcrumb">
            <li class="crumb-active">
              <a href="#" style="font-weight: bold;">结伴同游数据管理</a>
            </li>
            <li class="crumb-icon">
              <a href="dashboard.html">
                ...
                <table class="table" style="text-align: center;">
                  <thead >
                    <tr>
                      ...
                      <th class="text-center">结伴标题</th>
                      <th class="text-center">结伴目的地</th>
                      <th class="text-center">结伴日期</th>
                      <th class="text-center">创建时间</th>
                      <th class="text-center">结伴详情</th>
                  ...
                  <tbody> 
                   <?php if(is_array($travel)): $i = 0; $__LIST__ = $travel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><tr class="message-unread">
                     
                      <td><img src="/Campus/Public/Home/uploads/travelphoto/<?php echo ($vo2["pic"]); ?>" height="50px"></td>
                      <td><?php echo ($vo2["titles"]); ?></td>
                      <td>
                     
                      <?php echo ($vo2["site"]); ?></td>
                      <td><?php echo ($vo2["pretime"]); ?>~<?php echo ($vo2["endtime"]); ?></td>
                      
                      <td><?php echo ($vo2["creatime"]); ?></td>
                      <td><?php echo ($vo2["detail"]); ?></td>
                      <td><?php echo ($vo2["hits"]); ?></td>
                      <td><?php echo ($vo2["want"]); ?></td>
                      
                      
                     
                      <td>
                      
                        <a href="<?php echo U('deltrave',array('id'=>$vo2['id']));?>" title="删除"><i class="fa fa-trash"></i></a>
                      </td>
