  ...
  <div id="main">
    ...
    <section id="content_wrapper">
        ...
        <div class="topbar-left">
          <ol class="breadcrumb">
            <li class="crumb-active">
              <a href="#" style="font-weight: bold;">用户管理</a>
            </li>
            <li class="crumb-icon">
              <a href="dashboard.html">
      ...
      <section id="content" class="animated fadeIn">
            ...
            <div class="panel">
              ...
              <div class="panel-body ">
                <table class="table" style="text-align: center;">
                  ...
                  <tbody>
                  <?php if(is_array($usermodel)): $i = 0; $__LIST__ = $usermodel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><tr class="message-unread">
                     
                      <td><img src="/Campus/Public/Home/userphoto/<?php echo ($vo2["upic"]); ?>" height="50px"></td>
                      <td><?php echo ($vo2["uname"]); ?></td>
                      <td>
                      <input type="hidden" name="uid" value="<?php echo ($vo2["uid"]); ?>">
                      <?php echo ($vo2["telephone"]); ?></td>
                      <td><?php echo ($vo2["realname"]); ?></td>
                      <?php if($vo2["gender"] == '0'): ?><td>男</td>
                      <?php else: ?>
                      <td>女</td><?php endif; ?>
                      
                      <td><?php echo ($vo2["email"]); ?></td>
                      <td><?php echo ($vo2["dollar"]); ?></td>
                      <td><?php if($vo2["state"] == '1'): ?><span class="badge badge-warning  fs11">已禁用</span><?php else: ?><span class="badge badge-system  fs11">正常</span><?php endif; ?></td>
                      <td><?php echo ($vo2["constellation"]); ?></td>
                     

                      <td><?php echo ($vo2["info"]); ?></td>
                      <td><?php echo ($vo2["birthday"]); ?></td>
                      <td>
                      <?php if($vo2["state"] == '0'): ?><a href="<?php echo U('stopuser',array('id'=>$vo2['uid']));?>" style="margin-right:5px;" title="禁用"><i class="fa fa-lock" style="height: 2px"></i></a>
                        <?php else: ?>
                        <a href="<?php echo U('releaseuser',array('id'=>$vo2['uid']));?>" style="margin-right:5px;" title="取消禁用"><i class="fa fa-unlock"></i></a><?php endif; ?>
                        <a href="<?php echo U('user_del',array('id'=>$vo2['uid']));?>" title="删除"><i class="fa fa-trash"></i></a>
                      </td>
        ...
        <div style="float: right;margin-right: 480px"><?php echo ($link); ?></div> 
