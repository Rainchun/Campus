      ...
      <header id="topbar" class="alt">
        <div class="topbar-left">
          <ol class="breadcrumb">
            ...
            <li class="crumb-trail">用户收藏（推荐信息）</li>
          </ol>
        </div>
            ...
            <div class="panel">
              ...
              <div class="panel-body ">
                <table class="table" style="text-align: center;">
                  ...
                  <tbody> 
                  <?php if(is_array($redmodel)): $i = 0; $__LIST__ = $redmodel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><tr class="message-unread">
                     
                      <td><img src="/Campus/Public/Home/uploads/recmdphoto/<?php echo ($vo2["pic"]); ?>" height="50px"></td>
                      <td><a href="<?php echo U('Recommend/recmd_detail',array('id'=>$vo2['id']));?>"><?php echo ($vo2["name"]); ?></a></td>
                      <td>
                     
                      <?php echo ($vo2["place"]); ?></td>
                      ...
                      <td>
                        ...
                        <a href="<?php echo U('delcol',array('id'=>$vo2['cid']));?>" title="删除"><i class="fa fa-trash"></i></a>
                      </td>
